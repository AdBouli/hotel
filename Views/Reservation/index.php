<div class="row">
	<div class="col s10 offset-s1">
		<div class="row">
			...
			<div class="col s1">
				<a href="<?= WEBROOT ?>reservation/create" class="btn-floating btn-large waves-effect waves-light red">
		...
		<div class="row">
			...
			<div class="input-field col s2">
				<select name="paid">
			 	...
			 	<label for="paid">Reservation payée :</label>
			</div>
			<!-- SUBMIT BUTTON -->
			<div class="col s10">
...
<script>
	...
	$(function() {
		...
		$('#updateResult').click(function ()
		{
			...
			$.ajax({
				type: "POST",
				url: WEBROOT + "reservation/search",
				data: POST
			}).done(function (result)
			{
				$('#results').html(result);
